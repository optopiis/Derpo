...
const TopBar = () => {
  return (
    <div className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 flex items-center px-6 z-50">
      <h1 className="text-2xl font-serif text-gray-900 tracking-tight">Derpo</h1>
    </div>
  );
};
            ...
            {!hasSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="w-full max-w-[704px] mx-4">
                  ...
                  <div className="relative bg-gray-50 rounded-xl shadow-md border border-gray-300">
                    <textarea
                      ...
                      className="w-full p-5 pr-32 rounded-xl border-2 border-gray-300 focus:border-gray-900 focus:shadow-lg focus:outline-none resize-none h-[92px] bg-gray-100 text-gray-900 transition-all duration-200 placeholder-gray-500"
                      onKeyDown={(e) => {
              ...
              >
                {chatSections.map((section, index) => (
                  <div key={index} className="pt-8 border-b border-gray-200 last:border-0 bg-gray-50 rounded-xl shadow-sm px-4 py-6 mb-6">
                    {/* Query */}
                    <div className="mb-8">
                    ...
                    {/* Final Report */}
                    {section.response && (
                      <div className="mt-12 mb-16 bg-white rounded-lg shadow p-6 border border-gray-200">
